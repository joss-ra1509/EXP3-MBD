...
-- 1. TABLAS CON LAS COLUMNAS QUE PIDIÓ EL PROFE
...
CREATE TABLE Productos (
    ...
    Precio_Costo DECIMAL(10,2) NOT NULL,    -- <--- AQUÍ ESTÁ LO QUE FALTABA
    Margen_Ganancia DECIMAL(5,2) NOT NULL,   -- <--- AQUÍ ESTÁ LO QUE FALTABA
...
-- 3. PRUEBA DE FUEGO (Lo que vas a capturar para la foto)
